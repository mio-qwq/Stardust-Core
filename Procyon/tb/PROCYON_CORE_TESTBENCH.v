...
loop:
        ...
        __PROCYON_CORE.__MEM_UNIT.MEM[0] = 32'h000012b7;
        __PROCYON_CORE.__MEM_UNIT.MEM[1] = 32'hffc28293;
        __PROCYON_CORE.__MEM_UNIT.MEM[2] = 32'h001f8f93;
        __PROCYON_CORE.__MEM_UNIT.MEM[3] = 32'h01f2a023;
        __PROCYON_CORE.__MEM_UNIT.MEM[4] = 32'hff9ff06f;
        //第一次最基础的冒烟测试,通过了
        //TEST.mem的冒烟测试源代码如下
        .text
        .globl _start
