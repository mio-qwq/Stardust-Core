...
module CTRL_UNIT(
    ...
    wire [31:0]ALU_IMM;
    assign ALU_IMM=((INSTRUCTION[6:0]==7'b0010011)&&(INSTRUCTION[14:12]!=3'b001)&&(INSTRUCTION[14:12]!=3'b101))
    ?{{20{INSTRUCTION[31]}}, INSTRUCTION[31:20]}
    :((INSTRUCTION[6:0]==7'b0010011)&&((INSTRUCTION[14:12]==3'b001)||(INSTRUCTION[14:12]==3'b101)))
    ?INSTRUCTION[24:20]:0;
    //R-type instructions
    assign WHICH_REG1 =( (INSTRUCTION[6:0]==7'b0110011)||((INSTRUCTION[6:0]==7'b1100111)&&(INSTRUCTION[14:12]==3'b000))||(INSTRUCTION[6:0]==7'b1100011)||(INSTRUCTION[6:0]==7'b0100011)||(INSTRUCTION[6:0]==7'b0000011)||(INSTRUCTION[6:0]==7'b0010011))
    ?INSTRUCTION[19:15]: 0;
    ...
    assign ALU_IN2 = ((INSTRUCTION[6:0] == 7'b0110011) && (INSTRUCTION[30] == 0))
                     ?READ_REG2:
                     (((INSTRUCTION[30]==1)&&(INSTRUCTION[6:0] == 7'b0110011))?
                     ((INSTRUCTION[14:12]==3'b000)?~READ_REG2+1:READ_REG2)
                     :(((INSTRUCTION[6:0]==7'b0010011)?ALU_IMM:0)));
    assign ALU_IN1 = ((INSTRUCTION[6:0]==7'b0110011)||(INSTRUCTION[6:0]==7'b0010011))
    ?READ_REG1:0;
    assign ALU_OPT_CODE = ((INSTRUCTION[6:0]==7'b0110011)||(INSTRUCTION[6:0]==7'b0010011))
    ? INSTRUCTION[14:12]:0;
    assign REG_WE = ((INSTRUCTION[6:0]==7'b0110011)||(INSTRUCTION[6:0]==7'b1101111)||((INSTRUCTION[6:0]==7'b1100111)&&(INSTRUCTION[14:12]==3'b000))||(IF_LUI)||(IF_AUIPC)||(INSTRUCTION[6:0]==7'b0000011)||(INSTRUCTION[6:0]==7'b0010011))? 1: 0;
    assign WHICH_REG_WRITE = 
    ((INSTRUCTION[6:0]==7'b0110011)||(INSTRUCTION[6:0]==7'b1101111)||((INSTRUCTION[6:0]==7'b1100111)&&(INSTRUCTION[14:12]==3'b000))||(IF_LUI)||(IF_AUIPC)||(INSTRUCTION[6:0]==7'b0000011)||(INSTRUCTION[6:0]==7'b0010011))?
    INSTRUCTION[11:7]:0;
     
    assign WRITE_REG = ((INSTRUCTION[6:0]==7'b0110011)||(INSTRUCTION[6:0]==7'b0010011))? ALU_OUT://ALU OPT
    ...
    (INSTRUCTION_POINTER+{{11{INSTRUCTION[31]}},INSTRUCTION[31], INSTRUCTION[19:12], INSTRUCTION[20], INSTRUCTION[30:21], 1'b0})://JAL
